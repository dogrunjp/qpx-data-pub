...
シロイヌナズナ(*Arabidopsis thaliana*)の地上部器官発生RNA-seqデータ(https://www.ebi.ac.uk/biostudies/arrayexpress/studies/E-MTAB-7978)を、WikiPathwaysの光合成炭素還元経路図（(https://sandbox.wikipathways.org/pathways/WP1461.html)から引用し、更に文献を用い、編集しました。）の上に[QPX](https://github.com/bonohu/qpx)で表示できるようにした一式です。
